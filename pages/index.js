        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="flex items-center gap-3">
              <Eye className="text-argus-teal" size={32} />
              <div>
                <h1 className="text-3xl font-bold text-argus-navy">Argus</h1>
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="flex items-center gap-3">
              <div className="bg-argus-teal bg-opacity-20 p-2 rounded-lg">
                <Users className="text-argus-teal" size={20} />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Total Reps</p>
                <p className="text-2xl font-bold text-argus-navy">{mockPoliticians.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="flex items-center gap-3">
              <div className="bg-argus-orange bg-opacity-20 p-2 rounded-lg">
                <DollarSign className="text-argus-orange" size={20} />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Avg. Raised</p>
                <p className="text-2xl font-bold text-argus-orange">$2.1M</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Politicians Grid */}
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-argus-navy mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredPoliticians.map(politician => (
            <div key={politician.id} className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-all duration-200 hover:border-argus-teal">
              <div className="flex justify-between items-start mb-4">
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-argus-navy mb-1">{politician.name}</h3>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                <div>
                  ...
                  <p className="font-semibold text-argus-navy">{politician.yearsInOffice}</p>
                </div>
                <div>
                  <p className="text-gray-500 mb-1">Total Raised</p>
                  <p className="font-semibold text-argus-orange">
              ...
              <div className="border-t pt-3">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium text-argus-navy truncate">
        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Eye className="text-argus-teal" size={20} />
              <span className="font-semibold text-argus-navy">Argus</span>
            </div>
